...
<footer className="bg-black dark:bg-gray-900">
    ...
    <div className="px-4 py-6 bg-gray-400 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-900 dark:text-gray-300 sm:text-center">© 2024 <a href="https://flowbite.com/">Flowbite™</a>. All Rights Reserved.
        </span>
